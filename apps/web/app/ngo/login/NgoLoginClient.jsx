...
function NgoLoginForm() {
  ...
  return (
    <div className="w-full max-w-md mx-auto">
      ...
      <p className="mt-3 text-sm text-muted-foreground">For NGO accounts.</p>
      ...
      <form onSubmit={submit} className="mt-10 space-y-3">
        ...
        <p className="text-xs text-center text-muted-foreground">Not registered yet? <Link href="/ngo/register" className="text-primary">Register your organisation</Link></p>
      </form>
    </div>
  )
}

export default function NgoLoginClient() {
  return (
