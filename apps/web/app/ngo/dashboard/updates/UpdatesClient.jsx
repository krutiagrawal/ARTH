  ...
  return (
    <DashboardPageShell className="space-y-6">
      ...
      {loading ? null : items.length === 0 ? (
        <EmptyState icon={Newspaper} title="No updates yet" body="Post your first update to start building a following." actionLabel="New update" onAction={guard(() => setDialogOpen(true))} />
      ) : (
