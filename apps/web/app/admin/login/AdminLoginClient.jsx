...
function AdminLoginForm() {
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      router.push(searchParams.get('next') || '/admin/ngos')
    } catch {
  ...
  return (
    <div className="w-full max-w-md mx-auto">
      ...
      <h2 className="font-serif text-4xl md:text-5xl mt-4 leading-tight">ARTH <em className="italic text-primary">admin</em>.</h2>
      <p className="mt-3 text-sm text-muted-foreground">This signs you into the NGO-approvals admin. Content/CMS admin uses your regular <Link href="/login" className="text-primary">account login</Link> instead.</p>
