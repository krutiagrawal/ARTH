    ...
    <View style={styles.wrap}>
      ...
      <ScrollView horizontal showsHorizontalScrollIndicator={false}>
        {themes.map((theme) => (
          ...
          >
            <GlassCard variant={theme.unlocked ? 'sage' : 'dark'} style={[styles.card, !theme.unlocked && styles.cardLocked]}>
...
const styles = StyleSheet.create({
  ...
  emoji: { fontSize: 32 },
  name: { fontSize: 11, fontWeight: '600', color: COLORS.white, textAlign: 'center' },
  nameUnlocked: { color: COLORS.forest },
  locked: { fontSize: 10, color: COLORS.white },
});
