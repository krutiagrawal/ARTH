...
import { GroupChallengesScreen } from './GroupChallengesScreen';

type Segment = 'members' | 'challenges';

const SEGMENTS: { key: Segment; label: string; createRoute?: string; newLabel?: string }[] = [
  { key: 'members', label: 'Members' },
  { key: 'challenges', label: 'Challenges', createRoute: 'GroupCreateChallenge', newLabel: '+ New Challenge' },
];

export function GroupManageScreen({ navigation }: any) {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={[styles.header, { paddingTop: insets.top + 8 }]}>
        ...
        <Text style={styles.headerSubtitle}>Run your group's members and challenges</Text>
      </View>
      ...
      <View style={styles.body}>
        {segment === 'members' && <GroupMembersScreen navigation={navigation} />}
        {segment === 'challenges' && <GroupChallengesScreen navigation={navigation} />}
      </View>
    </View>
  );
}
