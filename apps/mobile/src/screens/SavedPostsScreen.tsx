...
import { useBlockTarget, useDeletePost, useSavedPosts, useToggleLike, useToggleSave } from '../hooks/useSocialQueries';
...
export function SavedPostsScreen({ navigation }: any) {
  ...
  const { data, isLoading, refetch, fetchNextPage, hasNextPage, isFetchingNextPage } = useSavedPosts();
    ...
    <View style={styles.container}>
      ...
      {isLoading ? (
        ...
        <FlatList
          ...
          ListEmptyComponent={<EmptyState icon="🔖" title="No saved posts yet" body="Posts you save for later will show up here." />}
        />
      )}
